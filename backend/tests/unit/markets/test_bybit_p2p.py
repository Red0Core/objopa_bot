...
from backend.services.markets.bybit_p2p import (
    BybitP2PResponse, categorize_all_offers, get_offers_by_amount,
    get_only_best_offers_by_valid_makers, generate_categories_html_output,
    generate_amount_html_output, get_p2p_orders, PAYMENT_TYPE
)
...
def test_get_offers_by_valid_makers():
    offers = [
        Offer(price=95.0, nickname="Regular1", finish_num=100, is_va=False, is_ba=False, 
              payment_types=("Сбер",), min_amount=1000, max_amount=10000, available_amount=100),
        Offer(price=95.5, nickname="Verified1", finish_num=200, is_va=True, is_ba=False, 
              payment_types=("Сбер",), min_amount=1000, max_amount=10000, available_amount=100),
        Offer(price=96.0, nickname="Business1", finish_num=300, is_va=False, is_ba=True, 
              payment_types=("Сбер",), min_amount=1000, max_amount=10000, available_amount=100),
        Offer(price=96.5, nickname="Regular2", finish_num=150, is_va=False, is_ba=False, 
              payment_types=("Тинек",), min_amount=1000, max_amount=10000, available_amount=100),
        Offer(price=97.0, nickname="Verified2", finish_num=250, is_va=True, is_ba=False, 
              payment_types=("Тинек",), min_amount=1000, max_amount=10000, available_amount=100),
    ]
...
def test_generate_amount_html_output():
    offers = [
        Offer(price=95.0, nickname="Regular1", finish_num=100, is_va=False, is_ba=False, 
              payment_types=("Сбер", "Тинек"), min_amount=1000, max_amount=10000, available_amount=100),
        Offer(price=96.0, nickname="Business1", finish_num=300, is_va=False, is_ba=True, 
              payment_types=("Сбер",), min_amount=1000, max_amount=10000, available_amount=100),
    ]
