...
from core.config import STORAGE_PATH, UPLOAD_DIR
    ...
    while True:
        ...
        for key in keys:
            ...
            try:
                ...
                await bot.send_message(chat_id=user_id, text="Выберите одно изображение:", reply_markup=keyboard, reply_to_message_id=msg[0].message_id) # type: ignore
